...
public class Pagination {
	...
	public String toString() {
		...
		buffer.append("<select name=ibm_crl_scm_page_size_select style='height:22px;' onchange='setPageSize(value); ' >");
		...
		buffer.append("   到<input type='text' name='ibm_crl_scm_goto_input' "
				+ " style='width:30px; font-size:12px; text-align:center; '>页");

		buffer.append("<input type='button' "
				+ " name='ibm_crl_scm_goto_button' value='跳转' class='button' >");
