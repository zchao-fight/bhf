...
<body>
	...
	<div class="content">
		<div class="breadcrumb">
			...
			<%-- <div style="float: right;display: none" id="hideSearch">
				<a href="javascript:void(0)"><img alt="取消" title="取消" src="${ctx }/images/cancel_icon.png" onclick="hideSearch()"></a>
			</div> --%>
			...
			<div style="float: right; display: none" id="search">
				<form action="${ctx}/search.action" method="post" onsubmit="return check()">
					<input id="searchContent" type="text" style="width: 200px" name="keyword"
