							...
							<h3 class="page-header">
								...
								<c:if test="${_user.uploadFilm != 1 }">
									...
									<c:if test="${_user.deleteFilm == 1}">
										<a style="float: right; font-size: 16px; color: blue"
											href="${ctx }/delete.action"><input type="button"
											class="FilmManagement" value="删除电影" /></a>
									...
									<c:if test="${_user.deleteFilm != 1}">
										...
										<c:if test="${ _user.manageFilmCategory == 1}">
											...
											<a style="float: right; font-size: 16px; color: blue"
												href="${ctx }/manageCategory.action"><input
												type="button" class="FilmManagement" value="管理电影" /></a>
