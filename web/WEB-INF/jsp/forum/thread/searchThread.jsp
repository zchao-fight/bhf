			...
			<table width="100%" cellspacing="0" cellpadding="0" align="center">
				<tr>
					<td><strong class="fl w"> <img
							...
							align="absmiddle" id="td_cate" style="cursor: pointer;" /><a
							style="font-size: 16px; font-weight: normal"
							href="${ctx }/category_list.do">论坛首页</a>&raquo; <span
							style="font-size: 16px; font-weight: normal">搜索结果</span>
					</strong>
						<div class="fr w">
			...
			<table cellspacing="0" cellpadding="0" width="100%" id="ajaxtable">
				...
				<tbody style="table-layout: fixed;">
					...
					<tr class="tr2">
						...
						<c:if
							test="${_user.onAndCancel == 1 || _user.deleteThread == 1 ||  _user.superAdmin}">
							<td class="y-style">操作</td>
						</c:if>
					</tr>
...
<c:if test="_user.onAndCancel == 1 ||  _user.superAdmin || _user.deleteThread == 1 ">
							<td width="10%" class="y-style" colspan="2"><c:if
									test="${_user.onAndCancel == 1 ||  _user.superAdmin}">
								...
								</c:if> <c:if test="${_user.deleteThread == 1 ||  _user.superAdmin}">
