	...
	<div class="content">
		<div class="breadcrumb">
			<a href="${ctx }/index.action">首页</a><span class="sep">&gt;</span><a
				href="${ctx }/law/more.action">政策法规</a><span class="sep">&gt;</span>更多
		...
		<div class="main">
			<ul class="news-list news-list-line">
				<c:forEach items="${data.list }" var="item">
					<li><a href="${ctx}/${url}${item.id}&tmp=<%=Math.random()%>">${item.name }</a>
			...
			<div class="page">
				共${data.total }条 <a
					href="${ctx }/law/more.action?page=${data.prePage}" class="btn"><i
